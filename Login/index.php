...
<body>
	<div class="main-w3ls">
		<div class="left-content" style="text-align: center;" align="center">
			...
			<img id="imagen" src="_plantilla/images/logoTec.jpg" /> 
			</div>
			 <div class="copyright">
			</div>
		</div>
		<div class="center-form-agile" style="text-align: center;" align="center">
			<div class="sub-main-w3">
				...
				<div class="form-style-agile">
					...
					<div class="input-group mb-3">
						...
						<input type="password" class="form-control" placeholder="Conraseña" aria-label="Password" id="txt_pass">
					</div>
				</div>
